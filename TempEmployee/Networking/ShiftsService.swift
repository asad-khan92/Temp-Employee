        ...
        if self.success{
            ...
            if ((shiftsArray?.count)! > 0) {
                ...
                for shift in  shiftsArray!{
                    ...
                    var ShiftObject = Shift(role: shift["role"] as? String, from_time: shift["from_time"] as? String, interview_time: shift["interview_time"] as? String, shift_hours: shift["shift_hours"] as? String, address: shift["address"] as? String, price_per_hour: shift["price_per_hour"] as? Float, shift_date: shift["shift_date"] as? String, reporting_to: shift["reporting_to"] as? String, phone: shift["phone"] as? String, details: shift["details"] as? String, special_info: shift["special_info"] as? String, site_instructions: shift["site_instructions"] as? String, required_licenses:  licenceArray, id : shift["id"] as! Int,assigned_job_seeker_id: shift["assigned_job_seeker_id"] as? Int, lat: shift["lat"] as! Double, lng : shift["lng"] as! Double, assign_status:status ,created_at:shift["created_at"] as? String,shift_status:shiftStatus!,totalCost:shift["total_cost"] as! Float)
