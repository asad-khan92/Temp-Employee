...
class DatePickerView: UIPickerView, UIPickerViewDelegate, UIPickerViewDataSource
{
    ...
    var monthFont = UIFont.HalisRRegular(size: 17)
    var monthSelectedFont = UIFont.HalisRRegular(size: 17)
    
    var yearFont = UIFont.HalisRRegular(size: 17)
    var yearSelectedFont = UIFont.HalisRRegular(size: 17)

    var monthTextColor = UIColor.black
    var monthSelectedTextColor = UIColor.blueThemeColor
    
    var yearTextColor = UIColor.black
    var yearSelectedTextColor = UIColor.blueThemeColor
    
    var dpDelegate: DatePickerDelegate?
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        {
            return (self.dpDelegate?.pickerView(didSelectMonth:months[row % months.count]))!
        }
         self.dpDelegate?.pickerView(didSelectYear:years[row % years.count])
